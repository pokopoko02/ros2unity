...
{
        public class MyPoseArrayPublisher : UnityPublisher<MessageTypes.Geometry.PoseStamped>//public class MyPoseArrayPublisher : UnityPublisher<MessageTypes.Nav.Path>//Geometry.PoseStamped>
    {   
